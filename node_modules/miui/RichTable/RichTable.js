...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"smui-table simple-table"},[_c('div',{on:{"click":_vm.click}},[(_vm.scrollX || _vm.scrollY)?_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.scrollX || _vm.scrollTop > 10),expression:"scrollX || scrollTop > 10"}],staticClass:"affix-head",class:{'scroll-y': _vm.scrollY, 'scroll-x': _vm.scrollX},on:{"scroll":_vm.scrollHorizon}},[_c('table',[_c('colgroup',[(_vm.selectable)?_c('col'):_vm._e(),_vm._v(" "),_vm._l((_vm.fields),function(field){return _c('col')})],2),_vm._v(" "),_c("table-head",{ref:"affix-head",tag:"thead",attrs:{"params":_vm.params},on:{"check-change":_vm.changeCheck}})])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"table-body",class:{'scroll-y': _vm.scrollY, 'scroll-x': _vm.scrollX, scrolling: _vm.scrollTop > 10},on:{"scroll":_vm.scrollVertical}},[_c('table',{staticClass:"table-content"},[_c("table-head",{ref:"head",tag:"thead",attrs:{"params":_vm.params},on:{"check-change":_vm.changeCheck}}),_vm._v(" "),_vm._l((_vm.items),function(item,row){return _c('tr',{staticClass:"table-row",class:{disabled: item.$disabled}},[(_vm.selectable)?_c('td',{attrs:{"data-col":"select","state":_vm.cellFilter('select', item)}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.selected),expression:"selected"}],attrs:{"type":"checkbox","disabled":item.$disabled},domProps:{"value":row,"checked":Array.isArray(_vm.selected)?_vm._i(_vm.selected,row)>-1:(_vm.selected)},on:{"change":function($event){var $$a=_vm.selected,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=row,$$i=_vm._i($$a,$$v);if($$c){$$i<0&&(_vm.selected=$$a.concat($$v))}else{$$i>-1&&(_vm.selected=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.selected=$$c}}}})]):_vm._e(),_vm._v(" "),_vm._l((_vm.fields),function(field){return _c('td',{attrs:{"data-col":field,"data-row":row}},[(_vm.cellComp[field])?_c(_vm.cellComp[field].tag,{directives:[{name:"model",rawName:"v-model",value:(item[field]),expression:"item[field]"}],tag:"component",attrs:{"params":_vm.cellComp[field],"item":item},domProps:{"value":(item[field])},on:{"input":function($event){var $$exp = item, $$idx = field;if (!Array.isArray($$exp)){item[field]=$event}else{$$exp.splice($$idx, 1, $event)}}}}):_c('div',{domProps:{"innerHTML":_vm._s(_vm.cellFilter(field, item))}}),_vm._v(" "),_c('div',{staticClass:"plugin-items",domProps:{"innerHTML":_vm._s(_vm.trickCellPlugin(field, item))}})],1)})],2)}),_vm._v(" "),(_vm.summary && _vm.summary.fields)?_c('tr',{staticClass:"summary-row"},[(_vm.selectable)?_c('td',{attrs:{"data-col":"check"}}):_vm._e(),_vm._v(" "),_c('td',{staticClass:"title",attrs:{"colspan":_vm.fields.length - _vm.summary.fields.length}},[_vm._v(_vm._s(_vm.summary.title))]),_vm._v(" "),_vm._l((_vm.summary.fields),function(field){return _c('td',{attrs:{"data-col":field}},[_vm._v("\n                        "+_vm._s(_vm.summaryData[field])+"\n                    ")])})],2):_vm._e()],2)])])])}
